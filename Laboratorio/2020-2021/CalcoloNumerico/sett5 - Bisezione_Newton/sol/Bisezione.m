...
%% METODO DI BISEZIONE CON SCELTA DEL CRITERIO DI ARRESTO
%
%                                               Versione 04-19-2021
%                                               Federico Piazzon
%
...
%                       flag = 'r' uscita per test dell residuo pesato ap
%                                  prossimato
...
switch method
    case 's' % test di arresto dello scarto
        ...
        while s>toll
            ...
            s=abs(iterates(3,n+2)-iterates(2,n+2));
            n=n+1;
        end
        if z==1
            flag='s';
    ...
    case 'm' % minimo dei due test
        ...
        while min(wres,s)>toll 
            ...
            res=f(iterates(1,n+1));
            wres=abs(res)*abs(iterates(1,n+1)-iterates(1,n))/abs(f(iterates(1,n+1))-f(iterates(1,n)));
            s=abs(iterates(3,n+1)-iterates(2,n+1));
        end
