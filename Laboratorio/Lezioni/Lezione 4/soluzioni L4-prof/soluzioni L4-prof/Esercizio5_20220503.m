...
% % secanti
% [zero1_s,res1_s,iterates1_s,flag1_s]=Secanti(f1,x0,x1,toll,itmax,method);
% [zero2_s,res3_s,iterates3_s,flag3_s]=Secanti(f3,x0,x1,toll,itmax,method);
% [zero4_s,res5_s,iterates5_s,flag5_s]=Secanti(f5,x0,x1,toll,itmax,method);
...
% err_1_s=abs(iterates1_s-xstar);
% err_3_S=abs(iterates3_S-xstar);
% err_5_S=abs(iterates5_s-xstar);
s1=abs(iterates1(2:end)-iterates1(1:end-1));
s3=abs(iterates3(2:end)-iterates3(1:end-1));
s5=abs(iterates5(2:end)-iterates5(1:end-1));
% s1_s=abs(iterates1_s(2:end)-iterates1_s(1:end-1));
% s3_s=abs(iterates3_s(2:end)-iterates3_s(1:end-1));
% s5_s=abs(iterates5_s(2:end)-iterates5_s(1:end-1));
